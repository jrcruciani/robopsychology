...
\texttt{guide.md} and \texttt{method.md}; this section formalizes them
for citation.
...
The repository's \texttt{taxonomy.md} document enumerates the
...
diagnostic entry point in the decision flowchart of \texttt{method.md}.
